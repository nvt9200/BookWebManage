  ...
  <aside class="app-sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
      <ul class="sidebar-nav">
        ...
        <li <?php if($currentFile=="manage_chapter.php" or $currentFile=="add_chapter.php" or $currentFile=="manage_chapter_list.php" or $currentFile==""){?>class="active"<?php }?>> <a href="manage_chapter.php">
