<?php include("includes/connection.php"); 
    ...
    if(isset($_GET['book_id']))
  {
      ...
      $query1 = mysqli_query($mysqli,"select * from tb_rating where book_id  = '$book_id' and user_id = '$user_id' "); 
      ...
      if(@count($rate_db1) == 0 ){
          ...
          $qry = Insert('tb_rating',$data); 
      
          //Total rate result
           
        $query = mysqli_query($mysqli,"select * from tb_rating where book_id  = '$book_id' ");
