<?php include('includes/header.php');
    ...
    if ($_FILES['user_image']['name'] != "") {
      ...
      $file_tem_loc=$_FILES["user_image"]["tmp_name"];

      //Main Image
      $tpath1='images/user_images/'.$user_image;
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="fileupload_block">
                        <input type="hidden" name="user_image_hidden" id="user_image_hidden" value="<?php echo $row['user_image'];?>">
                        <input type="file" name="user_image" value="fileupload" id="fileupload">
                          <?php if(isset($_GET['user_id']) and $user_row['user_image']!="") {?>
                            <div class="fileupload_img"><img type="image" src="images/user_images/<?php echo $user_row['user_image'];?>" alt="user image" /></div>
                          <?php } else {?>
                            <div class="fileupload_img"><img type="image" src="assets/images/add-image.png" alt="user image" /></div>
                          <?php }?>
                      </div>
                    </div>
                  </div>
