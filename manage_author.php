<?php include("includes/header.php");
   ...
   else
   {
    ...
    $img_res = mysqli_query($mysqli, 'SELECT * FROM tbl_author WHERE author_id=\'' . $_GET['author_id'] . '\'');
    $img_row = mysqli_fetch_assoc($img_res);
    
    if ($img_row['author_images'] != "") {
      unlink('images/author_images/' . $img_row['author_images']);
    }
              ...
              <tbody>
                ...
                <tr>                 
                  ...
                  <td><span class="category_img">
                    <?php if($row['author_image']!=null) {?>
                      <img type="image" src="images/author_images/<?php echo $row['author_image'];?>" />
                    <?php } else {?>
